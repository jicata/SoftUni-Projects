namespace RecyclingStation.WasteDisposal.Interfaces
{
    ...
    {
        /// <summary>
        /// An IStrategyCollector object holding the currently contained strategies.
        /// </summary>
        IStrategyCollector StrategyCollector { get;}

        /// <summary>
        /// Identifies and executes a disposal strategy from the strategies contained in the StrategyCollector based on the passed in garbage's Disposable Attribute.
        /// </summary>
