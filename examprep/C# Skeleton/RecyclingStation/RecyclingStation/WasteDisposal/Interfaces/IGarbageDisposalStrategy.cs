namespace RecyclingStation.WasteDisposal.Interfaces
{
    ...
    {
        /// <summary>
        /// Processes a passed in IWaste object by mapping out an appropriate strategy based on the object's Disposable Attribute. 
        /// The method returns an IProcessingData object containing all information about the results of the operation.
        /// </summary>
