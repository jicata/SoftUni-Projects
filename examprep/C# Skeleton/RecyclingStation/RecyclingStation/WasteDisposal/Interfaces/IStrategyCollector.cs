namespace RecyclingStation.WasteDisposal.Interfaces
{
    ...
    /// </summary>
    public interface IStrategyCollector
    {
        /// <summary>
        /// Returns a readonly version of the KeyValue collection of type Type-IGarbageDisposalStrategy, containing the currently mapped strategies.
        /// </summary>
        IReadOnlyDictionary<Type,IGarbageDisposalStrategy> GetDisposalStrategies { get; } 

        /// <summary>
        /// Maps a strategy to an attribute type and adds it to the currently contained strategies, can contain only unique attribute types.
        ///  Throws an exception in case that disposableAttribute is a type that is not derived from the Disposable Attribute class.
        /// </summary>
        ...
        /// <summary>
        /// Removes an attribute type and its corresponding strategy from the currently contained strategies.
        /// Throws an exception in case that the passed in disposableAttribute is a type not derived from the Disposable Attribute class.
        /// </summary>
        /// <param name="disposableAttribute">A type derived from the Disposable Attribute class.</param>
        ///  <exception cref="ArgumentException">In case the disposableAttribute is not a type derived from the Disposable Attribute class throws an Argument Exception.</exception>
